                  ...
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-8 * pi / 180)
                        ..translate(-10.0),
                      // ..translate(-10.0),
                      // cascade operator (..) operator does not return what the method returns
                      // but return what the previous method returns
                      decoration: BoxDecoration(
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (err.toString().contains('EMAIL_EXISTS')) {
        errorMessage = 'This email is already is in use.';
